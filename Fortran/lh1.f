...
c
     ...
     &               -u(ix  )*(1.-at12(ix  )/3./ak12(ix)))
          write(*,*) w(ix), abs(u(ix+1)-u(ix)), q, rho(ix), u(ix), 
     &               ak12(ix), at12(ix)
        end do
        do ix=1,nx-1
...
c
     ...
     &                   ethe, ekin
        if (mod(istep,250).eq.0) then
          write(16,102)(istep,t,ix,fm(ix),r(ix)/r(nx),u(ix),
...
c      write(16,101)(ix,fm(ix),r(ix)/r(nx),u(ix),
c    &      rho(ix),p(ix),eps(ix),w(ix),ix=1,nx)
  100 format(1x,i5,'; t:',1pe10.2,';  etot:',1pe10.2,
     &          ';  eth:',1pe10.2,';  ekin:',1pe10.2)
  101 format(1x,i5,1p7e12.4) 
  102 format(1x,i5,1pe10.2,i5,1p7e12.4) 
